...
app.get('/player_info', function(req, res) {
  var ids = 'Select id, name FROM football_players;';
  db.task('get-everything', task=>{
    return task.batch([
      task.any(ids),
    ]);
...
app.get('/player_info/post', function(req, res){
  ...
  var ids = 'SELECT id, name FROM football_players;';
  var info = 'SELECT year, major, passing_yards, rushing_yards, receiving_yards, img_src FROM football_players WHERE id= ' + player_choice + ';';
  var games = 'SELECT COUNT(*) AS games_played FROM football_games WHERE ' + player_choice + ' = ANY(players);';
  db.task('get-everything', task =>{
    return task.batch([
      task.any(ids),
      task.any(info),
